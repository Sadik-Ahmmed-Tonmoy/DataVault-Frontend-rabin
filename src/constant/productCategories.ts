  ...
  products: [
    {
      title: 'Gpu Server',
      description:
        "Take your data processing, machine learning models, and AI workloads to the next level with DataVault's GPU Servers. Designed for high-performance computing.",
    ...
    },
    {
      title: 'Vps Server',
      description:
        "Take your data processing, machine learning models, and AI workloads to the next level with DataVault's CPU Servers. Designed for high-performance computing.",
